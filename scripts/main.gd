...
func _process(delta):
	...
	var text = ""
	text += "Amethyst Plates: " + str(playerdata.spaceship_amethyst_gears) + "/5\n"
	text += "Cartons of Oil: " + str(playerdata.spaceship_carton_of_oil) + "/3\n"
	text += "Cobalt Plates: " + str(playerdata.spaceship_cobalt_gears) + "/5\n"
	text += "Computer Chips: " + str(playerdata.spaceship_computer_chip) + "/1\n"
	text += "Gold Plates: " + str(playerdata.spaceship_gold_gears) + "/5\n"
	text += "Machine Parts Box: " + str(playerdata.spaceship_machine_parts) + "/4\n"
	text += "Toolkit: " + str(playerdata.spaceship_thruster_repair_kits) + "/2\n"
